...
%load('~/data/mixture-res/FEATURES-timit-mask-mix-WHATTYPE-A-2a.mat');
%load('~/data/mixture-res/FEATURES-timit-mask-mix-SPEC-WHATTYPE-1.mat');
%load('~/data/mixture-res/FEATURES-timit-mask-mix-SPEC-WHATTYPE-1-A.mat');
%load('~/data/mixture-res/FEATURES-timit-mask-mix-WHATTYPE-A-1a.mat');
load('~/data/mixture-res/FEATURES-timit-mask-mix-WHATTYPE-A-2a.mat');
%load('~/data/mixture-res/FEATURES-timit-mask-mix-WHATTYPE-A-3a.mat');
...
valsNT=valsT;
%******
%valsT=20*log10(valsT); %LLLLOG NOTE NTOE NTOENTOETNOENTOETNOETNOENTOETNO
%******
...
[err,gamma,delta,numpred] = cvshrink(Mdl,'NumGamma',29,'NumDelta',29,'Verbose',3);
minerr = min(min(err));
%%
NUM_COEF=200;
